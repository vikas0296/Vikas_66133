...
import math as m
'''
All the functions necessary for the tip enrichment have been put together
'''
...
def enrichment_func_N1(F1, F2, F3, F4, dN, dF, N):
...
def enrichment_func_N2(F1, F2, F3, F4, dN, dF, N):
...
def enrichment_func_N3(F1, F2, F3, F4, dN, dF, N):
...
def enrichment_func_N4(F1, F2, F3, F4, dN, dF, N):
